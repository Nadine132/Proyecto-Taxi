...
const PrivacyPolicy = () => (
  <Section>
    ...
    <Paragraph>
      En [nombre del sitio web], la privacidad de nuestros usuarios es importante. Esta política de privacidad establece cómo recogemos, usamos y protegemos tu información personal.
    </Paragraph>
    <Paragraph>
