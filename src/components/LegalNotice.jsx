...
const LegalNotice = () => (
  <Section>
    ...
    <Paragraph>
      Este aviso legal regula el acceso y uso de la página web [nombre del sitio web]. El uso de esta página web implica la aceptación de las condiciones de uso.
    </Paragraph>
    <Paragraph>
